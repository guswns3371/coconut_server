...
exports.enterChatRoom = async function(io,user,sockets){
    ...
    io.emit('__chat_room_enter',`${currentRoomUserList}`);
};
...
exports.exitChatRoom = function(io,user,sockets){
    ...
    console.log({currentRoomUserList});
    io.emit('__chat_room_exit',`${currentRoomUserList}`);
};
                        ...
                        .then(res=>{
                            models.UserChatRoom.findOne({
                                ...
                                .then(res2=>{
                                    ...
                                    if (fcmToken !== null){
                                        fcmSender.sendTopicMessage(fcmTitle,fcmContent,fcmToken,
